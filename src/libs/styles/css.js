...
const auth = StyleSheet.create({
    ...
    auth_container: { width: "100%", backgroundColor: Colors.auth_card_bg, padding: 15, shadowColor: Colors.black, shadowOpacity: 0.2, shadowOffset: { width: 0, height: 2 }, shadowRadius: 4, elevation: 2, borderRadius: 10 },
    inputStyle: { borderWidth: 2, marginHorizontal: 5, paddingHorizontal: 10, paddingVertical: 8, fontSize: 20, color: 'black', borderRadius: 10, backgroundColor: "red" },
    scroll_container: { flexGrow: 1, paddingVertical: 50, width: "100%", },
    main_content: { alignItems: "center", justifyContent: "center", flex: 1 },
    //title
    auth_title: { fontSize: PoliceSize.auth_title_sz, color: Colors.home_card, marginBottom: 20 },
    //inputs
    input_container: { marginVertical: 5 },
    input_label: { fontSize: 15, marginBottom: 5 },
    phone_input_container: { flexDirection: "row", borderWidth: 1, borderColor: Colors.input_border_color, borderRadius: 5 },
    indicatif_input: { width: "22%", backgroundColor: "transparent", alignItems: "center", justifyContent: "center", borderRightColor: "red" },
    phone_input: { width: "78%", borderWidth: 0, paddingHorizontal: 5 },
    input: { borderWidth: 1, borderColor: Colors.input_border_color, borderRadius: 5, paddingHorizontal: 5 },
    auth_forgot_container: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginTop: 15 },
    auth_remember: { margin: 0 },
    auth_forgot: { color: Colors.input_border_color },
    checkboxContainer: { backgroundColor: "transparent", borderWidth: 0, padding: 1, margin: 0, },
    checkboxText: { color: "rgba(0,0,0,0.35)" },

    //auth bottom
    auth_bottom_container: { flexDirection: "row", alignItems: "center", justifyContent: "center", padding: 5, flexWrap: "wrap" },
    auth_bottom_label: {},
    auth_bottom_register_link: {},
    auth_bottom_register_link_text: { color: Colors.main, marginLeft: 4 },

    //button
    auth_submit_btn: { width: "100%", backgroundColor: Colors.main, padding: 15, borderRadius: 5, alignItems: "center", justifyContent: "center", marginVertical: 15 },
    auth_submit_btn_text: { fontSize: 17, color: Colors.white, fontWeight: "bold" },
    separator: { width: "100%", height: 1, backgroundColor: Colors.main, marginTop: 30 },

    //require
    require: { marginLeft: 2, fontSize: 12, color: Colors.danger },
    code_items: { width: "100%", flexDirection: "row", justifyContent: "space-between" },
    code_item: { width: "23%", height: 70, borderRadius: 5, borderWidth: 1, borderColor: "rgba(0,0,0,0.5)" }
    , code_input: { textAlign: "center", width: "100%", height: "100%", padding: 5, fontSize: 18, borderWidth: 0 },
    facebook: { width: "100%", paddingVertical: 18, justifyContent: 'center', alignItems: 'center', borderRadius: 5, flexDirection: "row", },
    info_text: { fontSize: 12, marginBottom: 20, textAlign: "justify" },
})
...
const profile = StyleSheet.create({
    container: { flex: 1 },
    profile_infos: { width: "100%", backgroundColor: Colors.main, flexDirection: "row", alignItems: "center", paddingLeft: 20, gap: 20, height: 250, borderBottomRightRadius: 120, borderTopLeftRadius: 50 },
    profile_image_container: { height: "60%", width: "38%", borderRadius: 9999999, backgroundColor: Colors.white, alignItems: "center", justifyContent: "center" },
    profile_image: { height: "95%", width: "95%", borderRadius: 9999999, resizeMode: "contain" },
    ...
    profile_item_icon_box: { backgroundColor: "rgba(0,0,0,0.1)", alignItems: "center", borderRadius: 10, padding: 5, paddingVertical: 8, width: 40, height: 40 },
    separator: { height: 1, width: "65%", backgroundColor: Colors.input_border_color, alignSelf: "flex-end" },
...
const filter = StyleSheet.create({
    ...
    item: { flexDirection: 'row', marginVertical: 8, justifyContent: 'space-between' },
    categories: { paddingVertical: 20, backgroundCol: Colors.white, },
    categorie_item: { flexDirection: 'row', alignItems: 'center', flexWrap: 'wrap', marginTop: 10 },
    cat_item: { paddingVertical: 5, paddingHorizontal: 10, borderWidth: 1, borderColor: Colors.gray, marginHorizontal: 5, marginBottom: 15, borderRadius: 15 },
    notes: { width: '15%', justifyContent: 'center', alignItems: 'center', flexDirection: 'row', borderRadius: 5, backgroundColor: Colors.light_gray, borderWidth: 0, padding: 10 },
});
