...
import { add_bid_data, get_all_encheres, get_enchere } from '../../../libs/redux/actions/enchere.action'
...
const Make_A_Bid = ({ navigation, route }) => {
    ...
    let lastAmount = parseInt(data?.history[data?.history?.length - 1]?.montant) || parseInt(data?.started_price);
